...
Define('RUIGEHOND006_VERSION', '1.0.3');
...
function ruigehond006_settings()
{
    ...
    if (!$option) {
        ...
        add_settings_field(
            ...
            __('Stick the bar to this element', 'ruigehond'), // title
            function ($args) {
        ...
        add_settings_field(
            ...
            // use $args' label_for to populate the id inside the callback
            __('Color of the progress bar', 'ruigehond'), // title
            function ($args) {
        ...
        add_settings_field(
            ...
            // use $args' label_for to populate the id inside the callback
            __('Progress bar thickness', 'ruigehond'), // title
            function ($args) {
        ...
        add_settings_field(
            ...
            function ($args) {
                ...
                echo '/> ' . __('use whole page to calculate reading progress', 'ruigehond') . '</label>';
            },
            'ruigehond006',
